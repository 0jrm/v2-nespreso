...
from nespreso.utils.time import datenums_to_datetimes
...
def test_datenums_to_datetimes_golden():
    golden = _load_golden()
    matlab_datenums = np.array([736863.0151, 736883.0033, 736903.4988])
    dts = datenums_to_datetimes(matlab_datenums)
